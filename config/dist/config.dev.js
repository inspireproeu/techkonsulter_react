...
var _process$env = process.env,
    REACT_APP_ENV = _process$env.REACT_APP_ENV,
    API_PREFIX = _process$env.API_PREFIX,
    SUB_DIR = _process$env.SUB_DIR;
  ...
  routes: [{
    ...
    routes: [{
      ...
      routes: [{
        ...
        name: 'UPDATE PROJECT',
        hideInMenu: true,
        component: './projects/components/CreateForm' // component: './projects/components/AddNewProject',
        ...
        hideInMenu: true,
        name: 'PROJECT ASSETS'
      }, _defineProperty(_ref, "hideInMenu", true), _defineProperty(_ref, "component", './assets/list/index'), _ref), {
        path: '/files',
        hideInMenu: true,
        name: 'FILES',
        component: './file/list'
        ...
        children: [{
          path: '/projects',
          // icon: 'form',
          name: 'PROJECTS' // component: './projects/list',
