...
import { PROJECT_STATUS, PROJECT_TYPES,WAREHOUSE } from '../../../utils/constants'
                        ...
                        <Grid item xs={4}>
                            <FormControl variant="outlined" className={'formControl'}>
                                ...
                                <Select
                                    labelId="demo-simple-select-outlined-label"
                                    id="demo-simple-select-outlined"
                                    value={values && values.sales_ref ? values.sales_ref : currentUser.id}
                                    name="sales_ref"
                                    onChange={handleChange('sales_ref')}
                                    label="Sales ref"
                                    notched={true}
                                    InputLabelProps={{
                                        shrink: true,
                                ...
                                >
                                    {
                                        adminUsers.map((option, index) => (
                                            <MenuItem key={index} value={option.id}>{option.first_name}</MenuItem>
                                        ))
                                    }
                                </Select>
                            </FormControl>
                       ...
                       <Grid item xs={4}>
                        <FormControl variant="outlined" className={'formControl'}>
                            ...
                            <Select
                                labelId="demo-simple-select-outlined-label"
                                id="demo-simple-select-outlined"
                                value={values && values.warehouse ? values.warehouse : 'SE01'}
                                name="warehouse"
