...
import { Pie, Column, G2, Bar, Funnel } from '@ant-design/plots';
...
class ComponentToPrint extends React.Component {
  ...
  render(props) {
    ...
    return (
      <div className="env_report" style={{ width: "100%", margin: "0 auto" }}>
        <div style={{ paddingBottom: 20 }} className={"bgfirst"}>
          ...
          <div className={"center"} style={{ minHeight: "300px", backgroundColor: "#b4b4b4", }} >
            <Row>
              <Col>
                <Title style={{ fontSize: 40, fontWeight: 600, color: "#fff" }}> Environmental Report</Title>
                <Title style={{ fontSize: 20, fontWeight: 500, color: "#25614e" }}>{values.client_name ? values.client_name : ''}</Title>
              </Col>
            </Row>
          </div>
          <div className={"center2"} style={{ width: "98%", margin: "0 auto" }} >
            <Row>
          ...
          <div >
            <Row>
              <Col lg={24} md={24} sm={24} xs={24} style={{ textAlign: 'center', paddingTop: 10 }}>
                ...
                <Title style={{ fontSize: 20, fontWeight: 700, lineHeight: 1.8, color: "#25614e", letterSpacing: 0.5 }}>{values.client_name ? values.client_name : ''}</Title>
          ...
          <div style={{ paddingTop: 80 }}>
            <Row>
              <Col lg={8} md={8} sm={8} xs={8} >
                <Paragraph italic className={"borderbottom"} style={{ fontSize: 16, fontWeight: 500, lineHeight: 1.8, color: "#25614e", letterSpacing: 0.5, textAlign: "end", marginBottom: 10 }}>{values?.partner_contact_name ? values?.partner_contact_name : ''}</Paragraph>
                <Paragraph style={{ fontSize: 16, lineHeight: 1.8, textAlign: "end" }}>{moment().format("YYYY-MM-DD")}</Paragraph>
              </Col>
            </Row>
          </div>
          <div className={"bottomlogo"}>
            <Image preview={false} src={logoDark} alt="logo" width={100} />
          </div>
        </div >
