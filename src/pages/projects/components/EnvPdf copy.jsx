...
import iteron_logo from '../../../assets/iteron_logo.png';
...
class ComponentToPrint extends React.Component {
  ...
  render(props) {
    ...
    const annotations = [];
    forEach(groupBy(remarketRecycled, 'type'), (values, k) => {
          ...
          <div className={"center"} >
            <Row>
              <Col style={{ paddingTop: 60 }}>
                <Image preview={false} src={itreon_logo_bg} alt="logo" width={600} />
                <Title style={{ fontSize: 28, color: "#004750", paddingTop: 20 }}> Environmental Report</Title>
                <Title className={'text-para1'}> This environmental report contains environmental information and data regarding project <br />{values?.id ? values.id : ''}</Title>
                {partner_logo && <Image style={{ paddingTop: 80 }} preview={false} src={partner_logo} alt="logo" width={200} />}
              </Col>
              <div className="footer">
                <Title style={{ fontSize: 20, color: "#004750", paddingTop: 20 }}> CONTENT</Title>
                <Title className={'text-para footer-comp-text1'}> Environmental accounting, Amount of equipment per category, Remarketing & recycling, CO 2 emissions from usage, Saved CO 2 , Certificate</Title>
              </div>
            </Row>
          </div>
        </div >
        {/* page2 */}
        <div style={{ paddingTop: 30, paddingBottom: 50, width: "90%", margin: "0 auto" }}>
          <div className="img-container">
            <Image preview={false} src={itreon_logo_grey} alt="logo" width={120} />
          </div>
          ...
          <div>
            <Row>
              <Col lg={24} style={{ paddingTop: 15 }}>
                <Paragraph className={"text-para"}>The main purpose of environmental reporting is to transparently account for the project's CO 2 emissions.</Paragraph>
                <Paragraph className={"text-para"} >We calculate the environmental impact in two different ways. Firstly, by assessing how much CO 2 is saved by reusing your equipment compared to purchasing new equipment. Secondly, by calculating the amount of CO 2 consumed during your use of the equipment.</Paragraph>
              </Col>
            </Row>
          </div>
          ...
          <div style={{ paddingTop: 2, paddingBottom: 40 }}>
          ...
          <div className="footer1">
            ...
            <Title className={"footer-comp-text"}>Gustavslundsvägen 147,167 51 Bromma<br />+46 70 938 95 99</Title>
            <Title className={"footer-comp-text"}>www.itreon.se</Title>
            <div style={{ clear: "both" }}></div>
          </div>
        </div >
        {/* page3 */}
        <div style={{ paddingTop: 10, width: "90%", margin: "0 auto" }}>
          <div className="img-container">
            <Image preview={false} src={itreon_logo_grey} alt="logo" width={120} />
          </div>
          <Row>
            <Col lg={12} md={12} sm={12} xl={12} xs={12}>
              <div style={{ marginBottom: 6 }}>
                <Title className={"environment"}>3.1 CO 2 emissions from usage</Title>
              </div>
              <Paragraph className={"text-para"}>CO 2 emissions depend on how long the equipment has been used and its condition. Equipment that can be remarketed is calculated as having consumed 50% of the carbon dioxide needed for its production. This is based on the knowledge that the equipment can be used for at least one more operational phase. Therefore, equipment that cannot be remarketed has consumed 100% of the carbon dioxide needed for its production.</Paragraph>
              ...
              <Paragraph className={"text-para"}>The CO 2 emissions from usage amounts to <span className="fw-bolder">-{totalConsumeCo2}</span> kg CO2.</Paragraph>
            </Col>
            <Col lg={12} xs={12} xs={12} xs={12} style={{ textAlign: "center" }}>
          ...
          <div style={{ paddingTop: 1, paddingBottom: 30 }}>
            <Row>
              <Col lg={12} md={12} sm={12} xs={12}>
                <div style={{ marginBottom: 10 }}>
                  <Title className={"environment"}>4.1 Saved CO 2</Title>
                </div>
                <Paragraph className={"text-para"}>We always strive to remarket equipment in cases where it is environmentally and economically justifiable. The graph to the right shows the amount of CO 2 saved per category.</Paragraph>
          ...
          <div style={{ paddingBottom: 20 }} className={"bgfirst"}>
            <div className={"center"} >
              <Row>
                ...
                {/* <div className="footer">
                  <Title style={{ fontSize: 20, fontWeight: 600, color: "#004750", paddingTop: 20 }}> CONTENT</Title>
                  <Title style={{ fontSize: 12, fontWeight: 600, color: "#004750", width: '68%', margin: '0 auto' }}> Environmental accounting, Amount of equipment per category, Remarketing & recycling, CO 2 emissions from usage, Saved CO 2 , Certificate</Title>
                </div> */}
              </Row>
