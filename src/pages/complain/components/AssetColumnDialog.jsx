...
export const AssetColumnDialog = (props) => {
  ...
  useEffect(() => {
    setAllColumnsOptions(
      [{
        header_name: "Minior", field: "minor"
      },
      { header_name: "Med", field: "medium" },
      { header_name: "Large", field: "large" },
      { header_name: "Serious", field: "serious" },
      { header_name: "Warning", field: "warning" }
      ]
    );

    let tempFields = data.complaint_types ? JSON.parse(JSON.stringify(data.complaint_types)) : [];
    setFields(tempFields);
  }, []);

  // console.log(allColumnsOptions,"fields*****",fields)
